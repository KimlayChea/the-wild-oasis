    ...
    <Table.Row>
      ...
      <div>
        <Modal>
          {/* Menu */}
          <Menus.Menu>
            {/* cuz we have many menu, so need we keep track it by
            id in every row which is currently displayed */}
          ...
          also no longer exists. then the modal window can no longer be shown. */}
